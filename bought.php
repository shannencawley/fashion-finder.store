...
// This is the current version for the changes that were made in the database
session_start();
...
// Query the `bought` table to get the viewed items for this UserID
$sql = "SELECT * FROM bought WHERE UserID = ?";
$stmt = $db->prepare($sql);
...
echo "<h2>Your Bought History</h2>";
